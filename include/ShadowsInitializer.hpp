...
/**
 * \file ShadowsInitializer.hpp
 * \brief Definition of ShadowsInitializer class
 * \author AnselmeClergeot
 * \version beta
 * \date 01/05/15
 *
 * ShadowsInitializer.hpp defines the ShadowsInitializer class
 *
 */

#ifndef SHADOWSINITIALIZER_HPP
#define SHADOWSINITIALIZER_HPP
