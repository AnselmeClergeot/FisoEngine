...
/**
 * \file DrawingFuncs.hpp
 * \brief Drawing functions
 * \author AnselmeClergeot
 * \version beta
 * \date 01/05/15
 *
 * DrawingFuncs.hpp offers functions linked with drawing things on screen
 *
 */

#ifndef DRAWINGFUNCS_HPP
#define DRAWINGFUNCS_HPP
#include "Vector2.hpp"
#include "Camera.hpp"
